...
set BASE_PATH=http://localhost:9060

REM URLs
set BRADESCO_INSTITUCIONAL=http://www.bradesco.com.br

set LOGIN_SERVICE=http://localhost:8080/login
...
set NPCC_LIMITE_CONSULTA=%BASE_PATH%/npcc-srv-limite-consulta/limites
set NPCC_SWIFT_CONSULTA=%BASE_PATH%/npcc-srv-swift-consulta/swifts
...
set CONSULTA_PACL=%BASE_PATH%/pacl-srv-grade-clie-servico
set BCPF_SRV_TAG_BIA=%BASE_PATH%/bcpf-srv-bac-validacao-tag-bia/routerBac
