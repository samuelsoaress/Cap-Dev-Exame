...
set LOCAL_BASE_PATH=http://localhost:9080
set TU_BASE_PATH=https://10.191.5.201
set TH_BASE_PATH=https://10.191.1.200

REM URLs
set BRADESCO_INSTITUCIONAL=http://www.bradesco.com.br

set LOGIN_SERVICE=%TU_BASE_PATH%/awb-login/sessions
